...
const NavigationScroll = () => {
  ...
  return (
    <div
      className={`hidden sm:block fixed z-999 top-0 left-0 right-0 bg-[#244CE7] text-white h-12 items-center  px-6 shadow-md transition-transform duration-300 ${
        show ? "translate-y-0" : "-translate-y-full"
      }`}
    >
      <div className="mx-auto px-0 h-12  flex justify-between items-center">
        <div className="flex items-center hover:opacity-60 transition-opacity duration-300">
          <svg
            className="h-3 w-60 cursor-pointer block"
            fill="white"

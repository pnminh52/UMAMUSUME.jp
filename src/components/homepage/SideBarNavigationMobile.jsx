          ...
          <div className="fixed inset-0 z-999 top-16">
            <div className="bg-[#0F5AFF]  w-full h-full p-6 relative">
              ...
              <ul className="px-4 py-0 mb-8">
                ...
                <li className=" gap-2 text-white  text-4xl font-semibold italic border-b h-16 border-white  flex items-center">{svg}Special</li>
                <li className=" gap-2 text-white  text-4xl font-semibold italic border-b h-16 border-white  flex items-center">{svg}Goods</li>
              </ul>
           <div>
            <img src="https://umamusume.jp/_nuxt/images/nav_cygamesid_banner-GYVDatWG.png" alt="" />
           </div>
            </div>
          </div>
        )}

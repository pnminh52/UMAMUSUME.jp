...
const Card8And9 = () => {
  return (
   <div className='relative'>
     <div className="py-20 gap-20 flex flex-col sm:flex-row items-center justify-center">
     <div className='cursor-pointer group relative '>
       ...
       <div className="absolute inset-0 bg-[#FF712F]/70 z-10 rounded-xl opacity-0 group-hover:opacity-100 group-hover:rounded-xl transition-opacity duration-300 hidden sm:block"></div>
    ...
    <button className="text-white cursor-pointer italic  bg-transparent
      ...
      <div className="flex items-center ml-2">
        ...
        <div className='transition-transform duration-300 ease-in-out transform group-hover:scale-110'>
          <img 
            ...
            src="https://umamusume.jp/_nuxt/images/img_special-al5A2Kph.jpg"            alt="" 
          />
     ...
     <div className='cursor-pointer group relative '>
           ...
           <div className="absolute inset-0 bg-[#FFC833]/70 z-10 rounded-xl opacity-0 group-hover:opacity-100 group-hover:rounded-xl transition-opacity duration-300 hidden sm:block"></div>
           <div className="absolute inset-0 z-11 flex justify-center items-center">
        <button className="text-white cursor-pointer italic  bg-transparent
          transform group-hover:translate-x-0 translate-x-full opacity-0 group-hover:opacity-100 
          transition-all duration-500 text-2xl flex items-center hidden sm:flex">
          ...
          <div className="flex items-center ml-2">
            ...
            <div className='transition-transform duration-300 ease-in-out transform group-hover:scale-110'>
              <img 
                className='rounded-lg transition-transform duration-300' 
                src="https://umamusume.jp/_nuxt/images/img_goods-lXA5DrVa.jpg"            alt="" 
              />

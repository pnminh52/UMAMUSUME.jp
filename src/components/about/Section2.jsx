...
const Section2 = () => {
  ...
  <div className="scroll-vertical absolute top-0 left-0 w-full">
    {/* Lặp lại ảnh 2 lần để tránh khoảng trắng */}
  ...
  <div className="flex flex-col items-center gap-4 text-center">
    ...
    <p className="text-xl text-white bg-black font-semibold w-100 px-4 py-1">
      <span className="text-2xl">「 ウマ娘 プロジェクト 」</span> とは？
    </p>
    <p className="px-36 text-lg">
      かつて名勝負、伝説のレース、偉大な記録を生んだ競走馬の名前と魂を受け継いだ「ウマ娘」たちが織り成すクロスメディアコンテンツ！
    </p>
    <p className="text-lg underline italic">
      <Link to={"/contents"}>Contents Top</Link>
    </p>
  </div>
</div>

  ...
  return (
    <div>
      <div className='hidden sm:block'>
        ...
        {/* Ảnh nền */}
        <img
          src="https://umamusume.jp/_nuxt/images/page5_kv-_50UepNX.jpg"
          alt=""
          className="w-full h-auto"
        />

<div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
  <div className="w-[50vw] h-50 opacity-85 bg-white transform -skew-x-12"></div>

  <div className='px-4 text-xl py-1 bg-[#2A5DFA] text-white absolute -top-4'>
    <span className="text-[#fff] text-2xl">「ウマ娘」</span>とは？
  </div>

  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[85%]">
    <p className="text-lg text-[#2A5DFA] relative z-10">

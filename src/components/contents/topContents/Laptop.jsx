...
const Laptop = () => {
  ...
  const listTab=[
    {
      ...
      name:"Game",
      title:"ゲーム",
      img:"https://umamusume.jp/_nuxt/images/btn_bg_game-fji__FPn.png",
    ...
    },
    {
      ...
      name:"Anime",
      title:"アニメ",
      img:"https://umamusume.jp/_nuxt/images/btn_bg_anime-KLSgRguk.png",
    ...
    },
    {
      ...
      name:"Music",
      title:"ミュージック",
      img:"https://umamusume.jp/_nuxt/images/btn_bg_music-VyxPFYMo.png",
    ...
    },
    {
      ...
      name:"Comics",
      title:"コミックス",
      img:"https://umamusume.jp/_nuxt/images/btn_bg_comics-VUe93ehm.png",
    ...
    },
    {
      ...
      name:"Event",
      title:"イベント",
      img:"https://umamusume.jp/_nuxt/images/btn_bg_event-Iej9qrM5.png",
  ...
  return (
    <div className="hidden sm:grid w-full grid-cols-[6fr_2fr] gap-4">
     ...
     <div className="  h-full flex justify-center items-center">
       ...
       autoPlay
       loop
       className="w-full h-auto max-h-[800px] rounded-r-2xl"
     >
      ...
      <div className="flex flex-col gap-4">
        ...
        className="relative bg-white text-[#4D4D4D] hover:text-white  hover:bg-[#878CA0] rounded-lg hover:scale-95 transition duration-300 ease-in-out cursor-pointer"
      >
      <Link to={tab.path}>
      <img
        ...
        <div className="absolute inset-0 flex flex-col justify-center pl-4">
          <span className="italic text-3xl ">{tab.name}</span>
